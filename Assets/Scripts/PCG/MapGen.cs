...
public class MapGen : MonoBehaviour {
	...
	void Update() {
		...
		//Modify this with a key
	}
	void spawnPlayer ()
	{
		//Vector3 testSpawn = new Vector3 (0, 0, 0); //needs 3 floats
			...
			foreach (Room roomB in roomListB) {
				...
				for (int tileIndexA = 0; tileIndexA < roomA.edgeTiles.Count; tileIndexA ++) {
					for (int tileIndexB = 0; tileIndexB < roomB.edgeTiles.Count; tileIndexB ++) {
						...
						if (distanceBetweenRooms < bestDistance || !possibleConnectionFound) { // || = if // if the correct distance is found 
...
// .....................................................
	...
	void RandomFillMap() {
		...
		for (int x = 0; x < width; x ++) {
			for (int y = 0; y < height; y ++) {
				if (x == 0 || x == width-1 || y == 0 || y == height -1) {   //Generate walls around the edge of the map 
